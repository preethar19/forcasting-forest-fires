...
Holding all other variables constant, for every one squared degree (Fahrenheit) 
increase in the average temperature of the dew on the grass (dewpoint), the odds 
a fire occurs are multiplied by a factor of 1.002 (exp(0.002)). 
