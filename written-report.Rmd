...
```
```{r}
ggplot(data = newfire, aes(x = avgsoiltemp)) +
...
```
```{r}
ggplot(data = newfire, aes(x = windrun)) +
  geom_histogram(stat = "count") +
...
```
```{r}
ggplot(data = newfire, aes(x = avgwindspeed)) +
  geom_histogram(stat = "count") +
...
```
```{r}
ggplot(data = newfire, aes(x = dewpoint)) +
  geom_histogram(stat = "count") +
  labs(x = "Dew Point (F)",
       y = "Count",
...
```
```{r}
ggplot(data = newfire, aes(x = avgrelhum)) +
  geom_histogram(stat = "count") +
...
```
```{r}
ggplot(data = newfire, aes(x = minrelhum)) +
  geom_histogram(stat = "count") +
...
```
```{r}
ggplot(data = newfire, aes(x = maxrelhum)) +
  geom_histogram(stat = "count") +
