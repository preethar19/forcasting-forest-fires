...
forest fires, as well as where the fires seem to be most frequent (Zaloumis, 2020).
...
Precipitation follows a unimodal right skewed distribution. Solar radiation 
appears to follow a bimodal distribution that has a slight left skew. Average 
soil temperature is a bimodal distribution.Wind run does not have a clear 
pattern, however the data points are more left skewed than central. Average vapor 
pressure follows a bimodal distribution. Average relative humidity is a multimodal
distribution. Average wind speed follows a right skewed unimodal distribution. Dew 
point follows a left skewed  unimodal distribution. Average air temperature does 
not have a clear pattern on the data, however the data points are more left 
skewed than center.
...
current form to show the distribution of each of the variables to help us identify
if any transformations might be necessary.
...
Our model indicates that the average amount of 
...
speed decreases the odds of a fire existing at a particular weather station. Our
aim was to identify the most significant predictors of forest fires in 
California, and all of the afformentioned variables would fall under such an 
umbrella.
