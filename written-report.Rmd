...
clear pattern, however the data points are more left skewed than central. There 
is a data point that is much smaller than the others, however it is unclear if 
...
air temperature does not have a clear pattern on the data, however the data 
points are more left skewed than center. Furthermore, there appears to be 
potential outlier points on the left side of the distribution.
